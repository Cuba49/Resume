...
namespace LogisticsDB.EditWindows
{
    public partial class Clients : Form
    {
        ...
        public Clients(MySqlConnectionStringBuilder mysqlCSB)
        {
        ...
        public void RefreshDB()
        {
            ...
            queryString = " select First_Name, Second_Name, midle_Name" +
                          " from client;" ;
        ...
        public void OkAddDB()
        {
            ...
            string queryString = "";
            if (!Test("select * from client where First_Name = '" + train[0] + "' and  Second_Name= '" + train[1] + "'and midle_Name= '" + train[2] + "' ;"))
            {
                queryString += " INSERT INTO client (First_Name, Second_Name,midle_Name)"
        ...
        public void SaveEdit()
        {
            ...
            if (!Test("select * from client where First_Name = '" + train[0] + "' and Second_Name = '" + train[1] + "' and midle_Name = '" + train[2] + "';"))
            {
                queryString += " UPDATE client set First_Name = '" + train[0] + "' , Second_Name = '" + train[1] + "' , midle_Name = '" + train[2] + "' where First_Name = '" + editTrain[0] + "' and Second_Name = '" + editTrain[1] + "' and midle_Name = '" + editTrain[2] + "' ; ";
            }
            using (MySqlConnection con = new MySqlConnection())
            {
                con.ConnectionString = mysqlCSB.ConnectionString;
        ...
        public void DelateDB()
        {
            ...
            string queryString = "DELETE FROM client WHERE First_Name = '" + train[0] + "' and Second_Name = '" + train[1] + "' and midle_Name = '" + train[2] + "' ; ";
            using (MySqlConnection con = new MySqlConnection())
            {
                con.ConnectionString = mysqlCSB.ConnectionString;
                com = new MySqlCommand(queryString, con);
