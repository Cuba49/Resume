...
namespace LogisticsDB.EditWindows
{
    public partial class Citys : Form
    {
        ...
        public Citys(MySqlConnectionStringBuilder mysqlCSB)
        {
        ...
        public void RefreshDB()
        {
            ...
            queryString = " select name_City, Map_City" +
                          " from city;" ;
        ...
        public void OkAddDB()
        {
            ...
            string queryString = "";
            if (!Test("select * from city where name_City = '" + train[0] + "' ;"))
            {
                queryString += " INSERT INTO city (name_City, Map_City)"
        ...
        public void SaveEdit()
        {
            ...
            string queryString = "";
            if (!Test("select * from city where name_City = '" + train[0] + "' and Map_City = '" + train[1] + "' ;"))
            {
                queryString += " UPDATE city set name_City= '" + train[0] + "', Map_City =  '" + train[1] + "' where name_City = '" + editTrain[0] + "' ; ";
            }
            using (MySqlConnection con = new MySqlConnection())
            {
                con.ConnectionString = mysqlCSB.ConnectionString;
        ...
        public void DelateDB()
        {
            ...
            string queryString = "DELETE FROM city WHERE name_City = '" + train[0] + "'; ";
            using (MySqlConnection con = new MySqlConnection())
            {
                con.ConnectionString = mysqlCSB.ConnectionString;
                com = new MySqlCommand(queryString, con);
