...
namespace LogisticsDB.EditWindows
{
    public partial class Cargo : Form
    {
        ...
        public Cargo(MySqlConnectionStringBuilder mysqlCSB)
        {
        ...
        public void RefreshDB()
        {
            ...
            queryString = " select name_Cargo, masa" +
                          " from cargo;";
        ...
        public void OkAddDB()
        {
            ...
            string queryString = "";
            if (!Test("select * from cargo where name_Cargo = '" + train[0] + "' and masa = '" + train[1] + "' ;"))
            {
                queryString += " INSERT INTO cargo (name_Cargo, masa)"
        ...
        public void SaveEdit()
        {
            ...
            if (!Test("select * from cargo where name_Cargo = '" + train[0] + "' and masa = '" + train[1] + "' ;"))
            {
                queryString += " UPDATE cargo set name_Cargo= '" + train[0] + "', masa =  '" + train[1] + "' where name_Cargo = '" + editTrain[0] + "' and masa = '" + editTrain[1] + "'; ";
            }
            using (MySqlConnection con = new MySqlConnection())
            {
                con.ConnectionString = mysqlCSB.ConnectionString;
        ...
        public void DelateDB()
        {
            ...
            string queryString = "DELETE FROM cargo WHERE name_Cargo = '" + train[0] + "' and masa = '" + train[1] + "'; ";
            using (MySqlConnection con = new MySqlConnection())
            {
                con.ConnectionString = mysqlCSB.ConnectionString;
                com = new MySqlCommand(queryString, con);
