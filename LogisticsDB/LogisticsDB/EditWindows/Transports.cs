...
namespace LogisticsDB.EditWindows
{
    public partial class Transports : Form
    {
        ...
        public Transports(MySqlConnectionStringBuilder mysqlCSB)
        {
        ...
        public void RefreshDB()
        {
            ...
            queryString = " select name_Transport, roominess, spead" +
                          " from transports;";
        ...
        public void OkAddDB()
        {
            ...
            string queryString = "";
            if (!Test("select * from transports where name_Transport = '" + train[0] + "' ;"))
            {
                queryString += " INSERT INTO transports (name_Transport, roominess, spead)"
                               + " VALUE('" + train[0] + "', '" + train[1] + "', '" + train[2] + "');";
            }
            using (MySqlConnection con = new MySqlConnection())
            {
                con.ConnectionString = mysqlCSB.ConnectionString;
        ...
        public void SaveEdit()
        {
            ...
            string queryString = "";
            if (!Test("select * from transports where name_Transport = '" + train[0] + "' and roominess = '" + train[1] + "' and  spead = '" + train[2] + "';"))
            {
                queryString += " UPDATE transports set name_Transport= '" + train[0] + "', roominess =  '" + train[1] + "', spead = '" + train[2] + "' where name_Transport= '" + editTrain[0] + "' and roominess= '" + editTrain[1] + "' and spead= '" + editTrain[2] + "'; ";
            }
            using (MySqlConnection con = new MySqlConnection())
            {
                con.ConnectionString = mysqlCSB.ConnectionString;
        ...
        public void DelateDB()
        {
            ...
            string queryString = "DELETE FROM transports WHERE name_Transport = '" + train[0] + "' and roominess = '" + train[1] + "' and spead = '" + train[2] + "'; ";
            using (MySqlConnection con = new MySqlConnection())
            {
                con.ConnectionString = mysqlCSB.ConnectionString;
                com = new MySqlCommand(queryString, con);
