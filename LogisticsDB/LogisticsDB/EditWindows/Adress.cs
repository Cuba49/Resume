...
namespace LogisticsDB.EditWindows
{
    public partial class Adress : Form
    {
        ...
        public Adress(MySqlConnectionStringBuilder mysqlCSB)
        {
        ...
        public void RefreshDB()
        {
            ...
            queryString = " select name_City, Second_Name, First_Name, Midle_name, street, house, flat" +
                          " from city, adress"+
                          " where adress.FKCity = city.id_City;" ;
            ...
            for (int j = 0; j < dt.Rows.Count; j++)
            {
                dataGridView1[7, j].Value = dataGridView1[0, j].Value;
            }
        ...
        public void OkAddDB()
        {
            ...
            dataGridView1[0, dataGridView1.RowCount - 2].Value = dataGridView1[7, dataGridView1.RowCount - 2].Value;
            for (int i = 0; i < dataGridView1.ColumnCount; i++)
            {
                train[i] = dataGridView1[i, dataGridView1.RowCount - 2].Value?.ToString();
            }
            string queryString = "";
            if (!Test("select * from adress where FKCity = (select id_City from city where name_City = '" + train[0] + "') and Second_Name = '" + train[1] + "' and  First_Name = '" + train[2] + "' and Midle_Name = '" + train[3] + "' and street = '" + train[4] + "' and house =  '" + train[5] + "' and flat = '" + train[6] + "' ;"))
            {
                queryString += " INSERT INTO adress (FKCity, Second_Name, First_Name, Midle_Name, street, house, flat)"
                               + " VALUE((select id_City from city where name_City = '" + train[0] + "'), '" + train[1] + "', '" + train[2] + "', '" + train[3] + "', '" + train[4] + "', '" + train[5] + "', '" + train[6] + "');";
            }
            using (MySqlConnection con = new MySqlConnection())
            {
                con.ConnectionString = mysqlCSB.ConnectionString;
        ...
        public void SaveEdit()
        {
            ...
            dataGridView1.CurrentCell = dataGridView1[1, 1];
            dataGridView1.CurrentCell = dataGridView1[2, 2];
            dataGridView1[0, numberOfEditRows].Value = dataGridView1[7, numberOfEditRows].Value;
            dataGridView1.Refresh();
            dataGridView1.ReadOnly = true;
            string[] train = new string[dataGridView1.ColumnCount];
            for (int i = 0; i < dataGridView1.ColumnCount; i++)
            ...
            if (!Test("select * from adress where FKCity = (select id_City from city where name_City = '" + train[0] + "') and Second_Name = '" + train[1] + "' and  First_Name = '" + train[2] + "' and Midle_Name = '" + train[3] + "' and street = '" + train[4] + "' and house =  '" + train[5] + "' and flat = '" + train[6] + "' ;"))
            {
                queryString += "UPDATE adress set FKCity = (select id_City from city where name_City = '" + train[0] + "'), Second_Name = '" + train[1] + "' ,  First_Name = '" + train[2] + "' , Midle_Name = '" + train[3] + "' , street = '" + train[4] + "' , house =  '" + train[5] + "' , flat = '" + train[6] + "' where FKCity = (select id_City from city where name_City = '" + editTrain[0] + "') and Second_Name = '" + editTrain[1] + "' and  First_Name = '" + editTrain[2] + "' and Midle_Name = '" + editTrain[3] + "' and street = '" + editTrain[4] + "' and house =  '" + editTrain[5] +"'"+(editTrain[6] == "" ? "" : (" and flat ='" + editTrain[6] + "'")) + ";";
            }
            using (MySqlConnection con = new MySqlConnection())
            {
                con.ConnectionString = mysqlCSB.ConnectionString;
        ...
        public void DelateDB()
        {
            ...
            string queryString = "DELETE FROM adress WHERE street = '" + train[4] + "' and  FKCity = (select id_City from city where name_City = '" + train[0] + "') and house =  '" + train[5] + "' and flat = '" + train[6] + "' and Second_Name = '" + train[1] + "' and First_Name= '" + train[2] + "' and Midle_Name = '" + train[3] + "';";
            using (MySqlConnection con = new MySqlConnection())
            {
                con.ConnectionString = mysqlCSB.ConnectionString;
                com = new MySqlCommand(queryString, con);
